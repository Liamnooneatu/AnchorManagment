  ...
  return (
    <div style={{ fontFamily: "Arial, sans-serif", lineHeight: "1.6" }}>
      ...
      <section style={{ background: "#f1f1f1", padding: "2rem" }}>
        ...
        <blockquote>
          “Best boat buying experience ever — smooth, honest, and professional.”
        </blockquote>
        <blockquote>
          “They helped me find the perfect family boat within my budget.”
        </blockquote>
      </section>
      ...
      <section style={{ padding: "2rem", textAlign: "center" }}>
        <h2>Contact Us</h2>
        <p>📍 Location: Ballybrit Ind Estate, Galway</p>
